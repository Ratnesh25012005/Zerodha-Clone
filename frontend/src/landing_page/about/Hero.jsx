      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:'1.8',fontSize:'1.2em'}}>
        <div className="col-6 p-5">
          <p>
            ...
            Zerodha, a combination of Zero and "Zerodha", the Sanskrit word for
            barrier.
          </p>
          <p>
        ...
        <div className="col-6 p-5">
          ...
          <p>
            <a href="" style={{textDecoration:'none'}}>Rainmatter</a>, our fin-tech fund and incubator, has invested in several
            fin-tech startups with the goal of growing the Indian capital
            markets.
          </p>
          <p>
